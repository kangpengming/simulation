...
public class TerrainManager8 : MonoBehaviour {
	...
	void Start () {
			...
			StartCoroutine(getTexture((int)xPosFloor+1,(int)yPosFloor+2));	
			//position = new Vector3(12000,0,24000);
			//SetTerrain(new Vector2(12000,24000));
	}
