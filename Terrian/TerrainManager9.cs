...
public class TerrainManager9 : MonoBehaviour {
...
//材质和高度
	...
	void Start () {
			...
			StartCoroutine(getTexture((int)xPosFloor+2,(int)yPosFloor+2));
			//position = new Vector3(24000,0,24000);
			//SetTerrain(new Vector2(24000,24000));
	}
