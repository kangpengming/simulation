...
public class TerrainManager4 : MonoBehaviour {
	...
	void Start () {
			...
			tempPos = new Vector2(xPosFloor*initiatWidth,(yPosFloor+1)*initiaLength);
			StartCoroutine(getTexture((int)xPosFloor,(int)yPosFloor+1));	
			//position = new Vector3(0,0,12000);
			//SetTerrain(new Vector2(0,12000));
	}
