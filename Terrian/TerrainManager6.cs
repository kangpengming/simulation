...
public class TerrainManager6 : MonoBehaviour {
	...
	void Start () {
			...
			StartCoroutine(getTexture((int)xPosFloor+2,(int)yPosFloor+1));
			//position = new Vector3(24000,0,12000);
			//SetTerrain(new Vector2(24000,12000));
	}
