...
public class TerrainManager3 : MonoBehaviour {
	...
	void Start () {
			...
			StartCoroutine(getTexture((int)xPosFloor+2,(int)yPosFloor));	
		//position = new Vector3(24000,0,0);
			//SetTerrain(new Vector2(24000,0));
//			WriteMessage("d:\test.txt","测试数据");
	}
