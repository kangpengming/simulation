...
public class TerrainManager7 : MonoBehaviour {
	...
	void Start () {
			...
			StartCoroutine(getTexture((int)xPosFloor,(int)yPosFloor+2));
			//position = new Vector3(0,0,24000);
			//SetTerrain(new Vector2(0,24000));
	}
